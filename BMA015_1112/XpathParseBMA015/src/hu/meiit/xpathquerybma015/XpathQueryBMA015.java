package hu.meiit.xpathquerybma015;
...
public class XpathQueryBMA015 {
    public static void main(String[] args) {
        ...
        try {
            ...
            XPathExpression firstName = xpath.compile("//student[@rollno=593]/firstname/text()");
            XPathExpression lastName = xpath.compile("//student[@rollno=593]/lastname/text()");
            XPathExpression nickName = xpath.compile("//student[@rollno=593]/nickname/text()");
            XPathExpression marks = xpath.compile("//student[@rollno=593]/marks/text()");
